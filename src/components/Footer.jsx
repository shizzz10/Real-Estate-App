      ...
      <div className="mainFooter" id="footer">
        ...
        <div className="upperFooter pad">
          <div className="upperFooterLogo">
            <img src="mg.png" loading="lazy" alt="make sense logo" />
          </div>
        ...
        <div className="lowerFooter pad">
          <div className="contact lowercol">
            <h5>Contact Us</h5>
            <a href="makesensebanigala@gmail.com">
              <MdEmail /> makesensebanigala@gmail.com
            </a>
            <a href="+92 333 9956347">
              <FaPhoneSquareAlt /> +92 333 9956347
            </a>
          </div>
          ...
          <div className="adress lowercol">
            <h5>Our Adress</h5>
            <p>
              <CiLocationOn /> Banigala Bhara Kahu link Road, Imran Society{" "}
            </p>
          </div>
        </div>
        <hr />
